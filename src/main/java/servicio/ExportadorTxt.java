...
public class ExportadorTxt extends Exportador{
	...
	public void exportarArchivo(String fileName, List<Cliente> listaClientes) {
		...
		System.out.println("Ingrese el nombre del directorio en donde desea exportar el archivo " + fileName + ".txt");
		...
		if(soname[0].equalsIgnoreCase("Windows")) {
			...
			if(fileName.equalsIgnoreCase(this.getFILENAME())) {
				ruta_archivo = "C:\\Users\\" + usuario + "\\Desktop\\" + nombrecarpeta +  "\\" + fileName + ".txt";
		...
		if(!forzado) {
			...
			ruta_archivo = "C:\\Users\\" + usuario + "\\Desktop\\" + nombrecarpeta +  "\\" + this.getFILENAME() + ".txt";			
		}else {
			ruta_archivo = "C:\\Users\\" + usuario + "\\Desktop\\" + nombrecarpeta +  "\\" + this.getNombreTemporal() + ".txt";	
		}
		...
		if (directorioFile.mkdirs()) {	
			...
			try {
				...
				for(Cliente cliente: listaClientes) {
					...
					bufferedWriter.write(cliente.getNombreCliente()+"\n");
					bufferedWriter.write(cliente.getApellidoCliente()+"\n");
					bufferedWriter.write(cliente.getAniosCliente()+"\n");
					bufferedWriter.write(cliente.getCategoria()+"\n");
				}
